...
call func.creastud(1, 'Виноградова', 'Дарья', 'Андреевна', null, '2002.03.22', 'Budapeshtskay 4', 
				   ...
				   'Мастер ремонтов холодильников', 89500066401, 'Не полная', 1,  'нет', 'нет', null, null); --1
call func.creastud(2, 'Бобров', 'Даниил', 'Андреевич', null, '2002.03.22', 'Budapeshtskay 4', 
				   'Budapeshtskay 4', 89500066401, 57841235, 56853526, 
				   'Серия: 4015 номер: 499821 дата выдачи: 01.04.2016 Выдан: УМФС РОСИИ', 3.94, 
				   'Абрикосова Рената Романовна', 'Бухгалтер', 89500066401, 'Виноградов Андрей Борисович', 
				   'Мастер ремонтов холодильников', 89500066401, 'Не полная', 1,  'нет', 'нет', null, null); --2
call func.creastud(2, 'Максим', 'Серебряков', 'Андреевич', null, '2002.03.22', 'Budapeshtskay 4', 
				   'Budapeshtskay 4', 89500066401, 57841235, 56853526, 
				   'Серия: 4015 номер: 499821 дата выдачи: 01.04.2016 Выдан: УМФС РОСИИ', 3.94, 
				   'Абрикосова Рената Романовна', 'Бухгалтер', 89500066401, 'Виноградов Андрей Борисович', 
				   'Мастер ремонтов холодильников', 89500066401, 'Не полная', 1,  'нет', 'нет', null, null); --3
call func.creastud(3, 'Пестов', 'Владимир', 'Тихонович', null, '2002.03.22', 'Budapeshtskay 4', 
				   'Budapeshtskay 4', 89500066401, 57841235, 56853526, 
				   'Серия: 4015 номер: 499821 дата выдачи: 01.04.2016 Выдан: УМФС РОСИИ', 3.94, 
				   'Абрикосова Рената Романовна', 'Бухгалтер', 89500066401, 'Виноградов Андрей Борисович', 
				   'Мастер ремонтов холодильников', 89500066401, 'Не полная', 1,  'нет', 'нет', null, null); --4
call func.creastud(3, 'Дорофеев', 'Ярослав', 'Проклович', null, '2002.03.22', 'Budapeshtskay 4', 
				   'Budapeshtskay 4', 89500066401, 57841235, 56853526, 
				   'Серия: 4015 номер: 499821 дата выдачи: 01.04.2016 Выдан: УМФС РОСИИ', 3.94, 
				   'Абрикосова Рената Романовна', 'Бухгалтер', 89500066401, 'Виноградов Андрей Борисович', 
				   'Мастер ремонтов холодильников', 89500066401, 'Не полная', 1,  'нет', 'нет', null, null); --5
call func.creastud(3, 'Афанасьев', 'Нисон', 'Альбертович', null, '2002.03.22', 'Budapeshtskay 4', 
				   'Budapeshtskay 4', 89500066401, 57841235, 56853526, 
				   'Серия: 4015 номер: 499821 дата выдачи: 01.04.2016 Выдан: УМФС РОСИИ', 3.94, 
				   'Абрикосова Рената Романовна', 'Бухгалтер', 89500066401, 'Виноградов Андрей Борисович', 
				   'Мастер ремонтов холодильников', 89500066401, 'Не полная', 1,  'нет', 'нет', null, null); --6
