...
<body>
	...
	<script src="./doc.js"></script>
        ...
        <button id="delall" class="btn btn-success">Удалить документы все</button> 
        <script src="./del/del.js"></script>
        <button id="del" class="btn btn-success">Удалить документ</button> 
        <p id="path"></p>
	<table id='table' border="1">
		...
		<tbody id='doc'>
            ...
            <br>
        <button id="sel" class="btn btn-success" >Добавить документ</button>  
