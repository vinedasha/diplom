...
function sel()
{
	...
	let input2 = document.getElementById('pa');
        ...
        let input22 = document.getElementById('dis');
         if(input.value == "" || input1.value == "" || input2.value == "" || input3.value == "" || input4.value == "" || input5.value == "" || input6.value == "" || input7.value == "" || input8.value == "" || input9.value == "" || input10.value == "" || input11.value == "" || input12.value == "" || input13.value == "" || input14.value == "" || input15.value == "" || input16.value == "" || input17.value == "" || input18.value == "" || input19.value == "" || input20.value == "" || input21.value == "" || input22.value == "")
         {
